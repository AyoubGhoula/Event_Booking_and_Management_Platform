...
const admin=()=>{
    ...
    const [counts, setCounts] = useState<{ userCount: number; organizerCount: number; eventCount: number }>({
        userCount: 0,
        organizerCount: 0,
        eventCount: 0,
    });
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8000/api/getCountsForAdmin', {
                    headers: {
