    ...
    <section className="bg-white dark:bg-gray-900">
        ...
        <form className="w-full max-w-md" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-center mt-6">
                <Link to="/Sign-in" className="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b dark:border-blue-400 dark:text-blue-300">
                    sign in
                </Link>

                <Link to="/Sign-up" className="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2 border-gray-500 dark:border-gray-400 dark:text-white">
                    sign up
                </Link>
            </div>
